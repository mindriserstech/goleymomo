...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="{{ asset('assets/img/sidebar-1.jpg') }}">
      <div class="logo"><span class="simple-text logo-normal">Goley Momo</span></div>
    ...
    <div class="main-panel">
      ...
      <footer class="footer">
        <div class="container-fluid">
          <div class="copyright">
            &copy;<script>document.write(new Date().getFullYear())</script> GOLEY MOMO | Developed by C4CRYPT
          </div>
        </div>
      </footer>
    </div>
